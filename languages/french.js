...
/* * About */
credits: 'about', about: function (arg, user, room) { var text = (room === user || user.hasRank(room.id, '#')) ? '' : '/pm ' + user.id + ', '; text += 'Je suis un **robot de Pokémon Showdown** qui a été écrit en Javascript pour node. Par Ecuacion : (https://github.com/Ecuacion/Pokemon-Showdown-Node-Bot), text); },
