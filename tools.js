...
global.addLeftZero = function(num, nz) {
...
global.generateRandomNick = function (numChars) {
...
global.equalOrHigherRank = function (userIdentity, rank) {
	if (rank === ' ') return true;
...
global.getTimeAgo = function(time) {
	time = Date.now() - time;
